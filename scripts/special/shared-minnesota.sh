...
cp $DIR_WALLPAPERS/rox-minnesota.jpg /usr/share/wallpaper

echo "Replacing the SLiM wallpaper\n"
rm /usr/share/slim/themes/antiX/*.jpg
cp $DIR_WALLPAPERS/login-minnesota.jpg /usr/share/slim/themes/antiX/background.jpg
...
if [ -d "/home/$USERNAME/.config" ]; then
	...
	cp $DIR_CONFIG/rox/pb_swift-minnesota /home/$USERNAME/.config/rox.sourceforge.net/ROX-Filer/pb_swift
fi

rm /etc/skel/.config/rox.sourceforge.net/ROX-Filer/pb*
cp $DIR_CONFIG/rox/pb_swift-minnesota /etc/skel/.config/rox.sourceforge.net/ROX-Filer/pb_swift

# Adding the startup audio clip
echo "Adding the startup audio clip"
mkdir /usr/share/sounds/startup
cp $DIR_SOUNDS/sound-minnesota.mp3 /usr/share/sounds/startup
...
if [ -d "/home/$USERNAME" ]; then
	...
	cp $DIR_CONFIG/conky/conkyrc-minnesota /home/$USERNAME/.conkyrc
fi
rm /etc/skel/.conkyrc
cp $DIR_CONFIG/conky/conkyrc-minnesota /etc/skel/.conkyrc
...
if [ -d "/home/$USERNAME/.icewm" ]; then
	...
	cp $DIR_CONFIG/icewm/startup-minnesota /home/$USERNAME/.icewm/startup
	chmod a+x /home/$USERNAME/.icewm/startup
fi
rm /etc/skel/.icewm/startup
cp $DIR_CONFIG/icewm/startup-minnesota /etc/skel/.icewm/startup
...
if [ -d "/home/$USERNAME" ]; then
	...
	chown $USERNAME:users /usr/share/sounds/startup/sound-minnesota.mp3
	...
	chown demo:users /usr/share/sounds/startup/sound-minnesota.mp3
