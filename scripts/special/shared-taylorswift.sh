...
cp $DIR_WALLPAPERS/rox-taylorswift.jpg /usr/share/wallpaper

echo "Replacing the SLiM wallpaper\n"
rm /usr/share/slim/themes/antiX/*.jpg
cp $DIR_WALLPAPERS/login-taylorswift.jpg /usr/share/slim/themes/antiX/background.jpg
...
cp $DIR_SOUNDS/sound-taylorswift.mp3 /usr/share/sounds/startup
...
if [ -d "/home/$USERNAME" ]; then
	...
	chown $USERNAME:users /usr/share/sounds/startup/sound-taylorswift.mp3
	...
	chown demo:users /usr/share/sounds/startup/sound-taylorswift.mp3
