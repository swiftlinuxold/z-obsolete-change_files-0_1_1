...
wget -U Firefox http://www.swiftlinux.org/wallpaper/rox-taylorswift.jpg
mv rox-taylorswift.jpg /usr/share/wallpaper

echo "Replacing the SLiM wallpaper"
rm /usr/share/slim/themes/antiX/*.jpg
wget -U Firefox http://www.swiftlinux.org/wallpaper/login-taylorswift.jpg
mv login-taylorswift.jpg /usr/share/slim/themes/antiX/background.jpg
...
if [ -d "/home/$USERNAME/.config" ]; then
	...
	cp $DIR_CONFIG/rox/pb_swift-taylorswift /home/$USERNAME/.config/rox.sourceforge.net/ROX-Filer/pb_swift
...
cp $DIR_CONFIG/rox/pb_swift-taylorswift /etc/skel/.config/rox.sourceforge.net/ROX-Filer/pb_swift
...
wget -U Firefox http://www.swiftlinux.org/sounds/sound-taylorswift.mp3
mkdir /usr/share/sounds/startup
mv sound-taylorswift.mp3 /usr/share/sounds/startup
...
if [ -d "/home/$USERNAME" ]; then
	...
	cp $DIR_CONFIG/conky/conkyrc-taylorswift /home/$USERNAME/.conkyrc
	chown $USERNAME:users /home/$USERNAME/.conkyrc
fi
rm /etc/skel/.conkyrc
cp $DIR_CONFIG/conky/conkyrc-taylorswift /etc/skel/.conkyrc
...
if [ -d "/home/$USERNAME/.icewm" ]; then
	...
	cp $DIR_CONFIG/icewm/startup-taylorswift /home/$USERNAME/.icewm/startup
	chmod a+x /home/$USERNAME/.icewm/startup
	chown $USERNAME:users /home/$USERNAME/.icewm/startup
fi
rm /etc/skel/.icewm/startup
cp $DIR_CONFIG/icewm/startup-taylorswift /etc/skel/.icewm/startup
